...
import com.cleartv.controller.common.util.ShellUtils.CommandResult;
 ...
 * <li>{@link PackageUtils#installSilent( String)}</li>
 * </ul>
 * <ul>
 * <strong>Uninstall package</strong>
 * <li>{@link PackageUtils#uninstallNormal(Context, String)}</li>
 * <li>{@link PackageUtils#uninstallSilent( String)}</li>
 * </ul>
 * <ul>
...
public class PackageUtils {
    ...
    public static int installSilent(String filePath) {
        return installSilent( filePath, " -r " + getInstallLocationParams());
    }
     ...
     *         {@link PackageUtils}.INSTALL_FAILED_*. same to {@link PackageManager}.INSTALL_*
     */
    public static int installSilent(String filePath, String pmParams) {
        ...
        CommandResult commandResult = ShellUtils.execCommand(command.toString(), ShellUtils.checkRootPermission(), true);
     ...
     * @param packageName package name of app
     * @return
     * @see #uninstallSilent(String, boolean)
     */
